<template>
    <svg class="w-full" viewBox="0 0 900 600" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="transparent" d="M0 0h900v600H0z" />
        <rect x="148" y="73" width="603" height="379" rx="28" fill="#fff" stroke="#E1E4E5" stroke-width="4" />
        <rect x="190" y="207.807" width="33.514" height="162.193" rx="4" class="fill-primary" />
        <rect x="242.003" y="155" width="34.669" height="215" rx="4" class="fill-primary" />
        <rect x="294.007" y="207.807" width="33.514" height="162.193" rx="4" class="fill-primary" />
        <rect x="400.326" y="207.807" width="33.514" height="162.193" rx="4" class="fill-primary" />
        <rect x="347.167" y="155" width="33.514" height="215" rx="4" class="fill-primary" />
        <rect x="453.486" y="155" width="33.514" height="215" rx="4" class="fill-primary" />
        ...
        <path d="m693.306 331.306-70.062-70.061a11.534 11.534 0 0 1-3.381-8.16V154m.805 103.402 89.092-51.47"
            stroke="#E1E4E5" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
        <path
        ...
        <path
            ...
            fill="url(#c)" />
        <circle cx="604.19" cy="504.191" r="15.191" transform="rotate(180 604.19 504.191)" class="fill-primary" />
        <circle cx="526.265" cy="368.265" r="7.265" transform="rotate(180 526.265 368.265)" class="fill-primary" />
        <circle r="13" transform="matrix(-1 0 0 1 430 454)" class="fill-primary" />
        <circle r="11" transform="matrix(-1 0 0 1 274 493)" class="fill-primary" />
        <circle r="9.907" transform="matrix(-1 0 0 1 779.907 413.907)" fill="#E1E4E5" />
        <circle r="10.556" transform="matrix(-1 0 0 1 67.556 503.679)" fill="#fff" />
        <circle r="8.467" transform="matrix(-1 0 0 1 391.466 412.467)" fill="#E1E4E5" />
        <circle r="12.923" transform="matrix(-1 0 0 1 703.922 108.923)" fill="#E1E4E5" />
        <circle r="4.929" transform="scale(1 -1) rotate(-75 -231.429 -302.887)" fill="#E1E4E5" />
        <circle r="11.245" transform="matrix(-1 0 0 1 311.245 165.245)" fill="#E1E4E5" />
        <ellipse rx="8.65" ry="6.92" transform="matrix(-1 0 0 1 691.419 389.89)" fill="#fff" />
        <ellipse rx="14.079" ry="11.115" transform="scale(-1 1) rotate(26.006 -1508.372 -1536.117)" fill="#fff" />
        ...
        <path
            ...
            fill="#E1E4E5" />
        <defs>
            <linearGradient id="a" x1="423.699" y1="444.626" x2="586.902" y2="367.523" gradientUnits="userSpaceOnUse">
                <stop stop-color="#fff" />
                <stop offset="1" stop-color="#EEE" />
            </linearGradient>
            <linearGradient id="b" x1="732.376" y1="370.22" x2="712.024" y2="440.584" gradientUnits="userSpaceOnUse">
                <stop stop-color="#fff" />
                <stop offset="1" stop-color="#EEE" />
            </linearGradient>
            <linearGradient id="c" x1="141.4" y1="400.702" x2="51.528" y2="259.819" gradientUnits="userSpaceOnUse">
                <stop stop-color="#fff" />
                <stop offset="1" stop-color="#EEE" />
            </linearGradient>
        </defs>
